...
<body>
				...
				<div class="col-lg-12">
					<div class="active-banner-slider owl-carousel">
						...
						<div class="row single-slide align-items-center d-flex">
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
									<h1>New MSI Laptop<br> Gaming!</h1>
						...
						<div class="row single-slide">
							<div class="col-lg-5">
								<div class="banner-content">
									<h1>New MSI<br>Laptop Gaming!</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
										dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
									<div class="add-bag d-flex align-items-center">
										<a class="add-btn" href=""><span class="lnr lnr-cross"></span></a>
							...
							<div class="single-deal">
								...
								<a href="img/category/c1.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Sneaker for eSport</h6>
									</div>
								</a>
							</div>
						</div>
			...
			<div class="row justify-content-center align-items-center">
				...
				<div class="col-lg-6 no-padding exclusive-right">
					<div class="active-exclusive-product-slider">
						...
						<!-- single exclusive carousel -->
						<div class="single-exclusive-slider">
							<a href="/details"><img class="img-fluid" src="{{url('public')}}/img/m2.png" alt="">
							<div class="product-details">
								<div class="price">
									<h6>$2,499.00</h6>
									<h6 class="l-through">$2,799.00</h6>
	...
	<section class="brand-area section_gap">
		<div class="container">
			<div class="row">
				<a class="col single-img" href="https://id.msi.com/" target="_blank">
					<img class="img-fluid d-block mx-auto" src="{{url('public')}}/img/brand/logomsi.png" alt="">
				</a>
				<a class="col single-img" href="https://id.msi.com/" target="_blank">
					<img class="img-fluid d-block mx-auto" src="{{url('public')}}/img/brand/logomsi.png" alt="">
				</a>
